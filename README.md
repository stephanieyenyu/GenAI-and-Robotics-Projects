...
* **Focus:** Generative AI, LLM Application, and Deep Learning.

---

## Repository Overview
This repository serves as a comprehensive portfolio of my projects developed during the **"Introduction to GenAI and Machine Learning"** course at NTU.

The projects demonstrate practical experience in **Large Language Models (LLMs)**, **Retrieval-Augmented Generation (RAG)**, and **Computer Vision**.
...
| **[Malicious Instruction Defense](./HW4-LLM-Defense)** | AI Safety | `Prompt Engineering`, `Safety Guardrails` | Designed defense mechanisms against prompt injection attacks to ensure model safety. |
...
| **[CNN Image Classification](./HW6-CNN-Classification)** | CV | `PyTorch`, `CNN`, `ResNet` | Trained a CNN model for anime character classification with data augmentation. |
...
* **LinkedIn:** [Stephanie Lin](https://www.linkedin.com/in/stephanie-lin-040663270/)
