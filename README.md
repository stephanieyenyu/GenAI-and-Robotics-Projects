...
| **[Digital Twin & Robotics Control](./Robotics-XR-Projects/Digital-Twin-UR3e)** | IoT / XR | `Unity`, `C#`, `TCP/IP`, `UR3e` | Real-time synchronization between Unity and physical UR3e robotic arm. |
